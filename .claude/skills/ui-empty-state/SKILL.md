...
- the **first-day onboarding / cold-start placement** flow (coverage capture, per-juz Solid/Shaky/Rusty, "when memorized", core-pack download) → use **ui-cold-start-placement**
