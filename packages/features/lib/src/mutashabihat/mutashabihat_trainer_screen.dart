    ...
    return KeyedSubtree(
      ...
      child: Scaffold(
        ...
        body: state.when(
          ...
          // The calm landing: until the reviewed dataset and the user's own
          // logged swaps populate it, a single calm aid-to-revision line — no
          // streak, no score, nothing "cured"/"safe to drop". The browsable
          // group list + drill entry (E14-T08) and the hotspots list (E14-T10)
          // fill this surface in.
          data: (_) => EmptyState(
